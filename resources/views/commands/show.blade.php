    ...
    <td colspan="2" class="p-4">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="text-right">
                {{-- Prix total depuis pivot --}}
                <p class="font-medium">{{ number_format($produit->pivot->sous_total, 2) }} MAD</p>
                <p class="text-sm text-gray-500">{{ number_format($produit->pivot->prix, 2) }} MAD × {{ $produit->pivot->quantite }}</p>
            </div>
        </div>
    </td>
</tr>
